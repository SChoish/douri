#!/usr/bin/env bash
# 3 환경 (cube-double, puzzle-3x3, antmaze-giant-navigate) diag_gaussian subgoal,
# horizon=25, plan_candidates=4 조합을 nohup + wait 으로 한 번에 하나씩 학습한다.
#
# 사용 예:
#   cd /home/choi/douri
#   nohup bash scripts/run_3env_diag_h25_pc4_sequential.sh \
#     > nohup_logs/seq_3env_diag_h25_pc4_$(date +%Y%m%d_%H%M%S).log 2>&1 &
#
# 환경 변수 override (선택):
...
CONFIGS=(
  "config/cube_double_phi_u4_a01_h25_pc4_ha5_kb93_kd80_tau5.yaml"
  "config/puzzle_3x3_phi_u4_a03_h25_pc4_ha5_kb90_kd50_tau5.yaml"
  "config/antmaze_giant_navigate_phi_u4_a03_h25_pc4_ha1_kb50_kd80_tau2.yaml"
)
