#!/usr/bin/env bash
# 4 환경(phi recipe; cube_double, puzzle_3x3, antmaze_giant_navigate, antmaze_teleport_navigate)을
# train_epochs=1000, horizon=10 으로 nohup + wait 으로 한 번에 하나씩 학습한다.
#
# 사용 예:
#   cd /home/choi/douri
#   nohup bash scripts/run_4env_phi_h10_e1000_sequential.sh \
#     > nohup_logs/seq_4env_phi_h10_e1000_$(date +%Y%m%d_%H%M%S).log 2>&1 &
#
# 환경 변수 override (선택):
...
CONFIGS=(
  "config/cube_double_phi_u4_gap20_envgoal_h10_1000.yaml"
  "config/puzzle_3x3_phi_u4_gap20_envgoal_h10_1000.yaml"
  "config/antmaze_giant_navigate_phi_u4_gap20_envgoal_h10_1000.yaml"
  "config/antmaze_teleport_navigate_phi_u4_gap20_envgoal_h10_1000.yaml"
)
