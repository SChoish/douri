...
#
# Usage:
#   cd <douri repo root> && nohup bash scripts/run_goub_phase1_antmaze_navigate_1000.sh &
# Log file is always under runs/nohup_goub_phase1_antmaze_<timestamp>.log (see below).
set -euo pipefail
