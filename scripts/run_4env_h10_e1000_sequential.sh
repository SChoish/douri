...
# 사용 예:
#   cd /home/choi/douri
#   nohup bash scripts/run_4env_h10_e1000_sequential.sh \
#     > nohup_logs/seq_4env_h10_e1000_$(date +%Y%m%d_%H%M%S).log 2>&1 &
#
# 환경 변수 override (선택):
...
for CONFIG_PATH in "${CONFIGS[@]}"; do
  ...
  step_log="${LOG_DIR}/seq${stage}_${stem}_h10_e1000_${ts}.log"
